...
```
```{r deseq2b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, message=FALSE, echo=FALSE, out.width='70%', fig.align='center'}
...
```{r deseq5b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, message=FALSE, echo=FALSE, out.width='70%', fig.align='center'}
...
```{r deseq6b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, message=FALSE, echo=FALSE, out.width='70%', fig.align='center'}
...
```{r deseq7b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, message=FALSE, echo=FALSE, out.width='70%', fig.align='center'}
...
Let's train a set of machine learning models to classify samples into classes. 

First, select taxa from DESeq2 results:

```{r pred1, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, fig.show='hide', message=FALSE}
...
Now, compute a PCA using VST abundances from DESeq2 (or transformed in any other way):

```{r pred2, fig.width=12, fig.height=8, warning=FALSE, error=FALSE, message=FALSE, fig.align='center'}
...
```
Train models with the PCs. The package provides default parameters for XGBoost, CatBoost and RandomForest stored in the `xgboost_params_default`, `catboost_params_default` and `randomforest_params_default` variables. 

```{r pred3, fig.width=12, fig.height=8, warning=FALSE, error=FALSE, message=FALSE, fig.align='center'}
...
```{r pred4, fig.width=12, fig.height=10, warning=FALSE, error=FALSE, message=FALSE, fig.align='center'}
