...
```{r beta2, fig.width=12, fig.height=5, warning=FALSE, message=FALSE}
library(cowplot)
...
```
```{r deseq2b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, fig.show='hide', message=FALSE, echo=FALSE}
...
```
```{r deseq5b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, fig.show='hide', message=FALSE, echo=FALSE}
...
```{r deseq6b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, fig.show='hide', message=FALSE, echo=FALSE}
...
```{r deseq7b, fig.width=12, fig.height=4, warning=FALSE, error=FALSE, fig.show='hide', message=FALSE, echo=FALSE}
