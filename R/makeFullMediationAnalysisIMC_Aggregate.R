...
#' @title Perform Full Mediation Analysis Aggregated by IMC (BMI)
#' @description
...
#'
#' @param opt A list or object containing parameters and paths, including an output directory path in `opt$out`.
#' @param getVarsFunctions A function that, given a data frame of merged p-values, returns a character vector
#'  of variable names selected for mediation analysis.
#' @param mediator_name Name of the mediator variable (default: "IMC").
#' @param y_name Name of the binary outcome variable (default: "Condition_bin").
#' @param plim P-value cutoff for filtering variables in the mediation analysis (default: 0.05).
#' @param plim_plot P-value cutoff for plotting significance (default: 0.05).
#' @param name Prefix name used in output plot filenames (default: "analysis_IMC_separateModel_vjust").
#' @param wnet Width of network plot in inches (default: 14).
#' @param hnet Height of network plot in inches (default: 12).
#' @param wbars Width of bar plots in inches (default: 8).
#' @param hbars Height of bar plots in inches (default: 10).
#' @param wbars2 Width of alternative bar plots in inches (default: 10).
#' @param hbars2 Height of alternative bar plots in inches (default: 12).
#' @param use_color_scale Logical; whether to use a color scale in plots (default: FALSE).
#' @param fix_barplot_limits Logical; whether to fix limits in bar plots (default: FALSE).
#' @param custom_colors Optional vector of custom colors for plotting (default: NULL).
#'
